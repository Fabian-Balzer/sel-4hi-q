...
def plot_band_number_distribution(df, excluded_surveys=("hsc", "kids"), suffix=""):
    ...
    cm.save_figure(fig, "input_analysis/band_number_distribution{suffix}")
...
if __name__ == "__main__":
    ...
    # band_count_df1 = plot_input_distribution(df)
