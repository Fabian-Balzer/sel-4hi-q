...
OUT_FPATH=${OUTPUT_PATH}${STEM_OUT}_pointlike.out

printf $OUT_FPATH
# Check whether there already is an output file:
if [ -f "${OUTPUT_PATH}${STEM_OUT}_pointlike.fits" ]
    then
...
# -CAT_IN ${INPUT_PATH}${STEM}_pointlike.in \
# -CAT_OUT $OUT_FPATH \
# -PARA_OUT ${PARAPATH}outputpara.para \
# -ZPHOTLIB ${LIB_PATH}${LIB_STEM}_mag_lib,star_mag_lib \
# -MAG_REF 7 \
# -MAG_ABS -30,-20 \
...
# jystilts $LEPHARE/lephare_scripts/jystilts/rewrite_fits_header.py ${PARAPATH}outputpara.para $OUT_FPATH
